...
<script type="text/javascript">
	...
	function doExport(){
		...
		window.location.href = "${pageContext.request.contextPath}/subarea/subareaAction_exportXls.action";
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath}/subarea/subareaAction_pageQuery.action",
			idField : 'id',
			columns : columns,
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addForm" action="${pageContext.request.contextPath }/subarea/subareaAction_add.action" 
					method="post">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  
    							...
    							url:'${pageContext.request.contextPath }/region/regionAction_list.action'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
