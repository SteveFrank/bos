...
<script type="text/javascript">
	$(function() {
		$("#grid").datagrid({
			...
			url : '${pageContext.request.contextPath}/noticebill/noticebill_findnoassociations.action'
		});
				...
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						...
						<td><input class="easyui-combobox" required="true"
							name="staff.id"
							data-options="valueField:'id',textField:'name',url:'${pageContext.request.contextPath }/staff/staff_ajaxlist.action'" />
						</td>
					</tr>
				</table>
			</form>
