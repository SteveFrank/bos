...
<script type="text/javascript">
	...
	function logoutFun() {
		...
		.confirm('系统提示','您确定要退出本次登录吗?',function(isConfirm) {
			if (isConfirm) {
				location.href = '${pageContext.request.contextPath }/user/userAction_logout.action';
			}
		});
	}
	...
	// 版权信息
	function showAbout(){
		$.messager.alert("宅急送 v1.0","管理员邮箱: it_boy2015@126.com");
	}
</script>
</head>
				...
				<tr>
					<td style="width: 300px;">
						<div style="color: #999; font-size: 8pt;">
							南京大学软件学院 | Powered by <a href="http://www.nju.edu.cn/">www.nju.edu.cn</a>
						</div>
					</td>
		        ...
		        <form id="editForm">
	                <table cellpadding=3>
	                    <tr>
	                        ...
	                        data-options="validType:'length[3,6]'"  type="Password" class="txt01 easyui-validatebox" /></td>
	                    </tr>
	                    <tr>
	                        <td>确认密码：</td>
            ...
            <script type="text/javascript">
            	...
            	$("#btnEp").click(function(){
            		...
            		if(v) {
            			...
            			if(v1 == v2) {
            				var url = '${pageContext.request.contextPath}/user/userAction_editPassword.action';
